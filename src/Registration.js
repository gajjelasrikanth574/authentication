                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <div className="form-group">
                                    ...
                                    <input type="radio" checked={gender==="male"} onChange={e=>genderchange(e.target.value)} name="gender" value="male" className="app-check"></
                                    input>
                                    <label>Male</label>
                                    <input type="radio" checked={gender==="female"} onChange={e=>genderchange(e.target.value)} name="gender" value="female" className="app-check"></
                                    input>
                                    <label>Female</label>
